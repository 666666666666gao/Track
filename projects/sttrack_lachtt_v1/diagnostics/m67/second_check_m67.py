...
assert trajectories['reference']==trajectories['control'] and losses_by_arm['reference']==losses_by_arm['control']
assert final['reference']==final['control'] and final['support']!=final['control']
result=dict(status='fit_smoke_pass',observed_utc=datetime.now(timezone.utc).isoformat(),checker_sha256=sha(__file__),
    ...
    zero_weight_control_matches_M65_training_states_losses_and_final_tensors=True,arms=results,
