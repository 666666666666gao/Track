...
r=dict(status='control_mismatch_diagnostic',first_differences=diff[:4],different_frames=len(diff),
...
(ROOT/'control_mismatch_diagnostic.json').write_text(json.dumps(r,indent=2)+'\n');print(json.dumps(r,indent=2))
