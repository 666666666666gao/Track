#!/usr/bin/env python3
"""VOT-RGBD2022 entry for the single frozen STTrack no-update intervention."""
...
DISABLED_UPDATE_INTERVAL = 1_000_000_000
...
cfg.TEST.UPDATE_INTERVALS = DISABLED_UPDATE_INTERVAL
