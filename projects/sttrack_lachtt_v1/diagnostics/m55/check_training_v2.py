...
def main():
    ...
    result = dict(status='complete_training_contract', variant=variant,
        ...
        batch_size=2, search_frames=4, training_steps=3, keep_rate=[1.], trainable_parameters=sum(p.numel() for p in network.parameters()),
    ...
    output = root / 'contract_v2' / (variant + '_result.json')
