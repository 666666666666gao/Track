...
def main():
    ...
    def checkpoint(complete):
        return dict(architecture='semantic_spatial_centered_v1', null_support=True, support_loss_weight=spec['support_loss_weights'][args.arm], arm=args.arm, model=tracker.network.semantic_adapter.state_dict(),
