...
def analyze():
    ...
    per={'native':native['per_sequence']['native'],'M82_mask_control':parent['per_sequence']['category'],**{a:{} for a in FAMILIES}}
    ...
    gates=dict(M82_increment=compare(aggregates['M82_mask_control']),native=native_gates,
