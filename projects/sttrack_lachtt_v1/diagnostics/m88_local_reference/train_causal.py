"""Single-seed centered Category causal training with reliable same-state native spatial KL."""
import argparse
...
def main():
    ...
    root = Path('/root/autodl-tmp/sttrack_m88_local_reference_20260921')
    ...
    def checkpoint(complete):
        return dict(architecture='semantic_spatial_local_reference_v1', null_support=True, support_loss_weight=spec['support_loss_weights'][args.arm], arm=args.arm, model=tracker.network.semantic_adapter.state_dict(),
