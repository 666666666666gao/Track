...
OUT = Path('/root/autodl-tmp/sttrack_m58_completion_audit_v3_20260906')
...
def main():
    ...
    for arm in ['text', 'visual']:
        ...
        assert [r['sequence'] for r in logs] == [r['sequence'] for r in training['sequence_order']]
        ...
        counts = dict(sum((Counter(r['label_counts']) for r in logs), Counter()))
