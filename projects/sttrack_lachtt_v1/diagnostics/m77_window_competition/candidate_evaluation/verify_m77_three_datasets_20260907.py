"""Verify complete saved predictions and numeric targets for one M77 bundle."""
...
def main():
    helper=module('final_helper',Path('/root/autodl-tmp/m77_full_preparation_20260907.py'))
    ...
    analysis=master/'analysis/m77_category_full127_analysis.json';assert sha(analysis)==vot['analysis_sha256']
