"""Conditional full-dataset preparation for the unchanged M77 bundle."""
import argparse
...
EXTRA_SOURCES=['m77_full_preparation_20260907.py','m77_full_vot_20260907.py','verify_m77_three_datasets_20260907.py','m77_full_evaluation_20260907.sh']
CANDIDATE_SPEC_SHA='7626558230f864237b49aa4e77bd2cf7fe32c8af46d46cb3753584ac4db9483d'


def contracts():
    assert sha(ROOT/'spec.json')==CANDIDATE_SPEC_SHA
    candidate=module('candidate77',Path('/root/autodl-tmp/m77_candidate_evaluation_20260907.py'))
...
def check_sources():
    ...
    result=dict(status='M77_full_dataset_sources_and_counts_verified_only',observed_utc=datetime.now(timezone.utc).isoformat(),
        ...
        next='After actual M77 low22 pass only: causal initialization captions and category encoding, fixed-bundle OPE/full127, saved-output and target verification.',
...
if __name__=='__main__':
    ...
    elif a.action=='eligible':eligible();print('M77_FULL_LOW22_PREREQUISITES_VERIFIED')
