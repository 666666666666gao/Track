...
TRACKER='sttrack_m77_category_low22'
...
def prepare():
    ...
    path=Path('/root/autodl-tmp/m77_learned_entry_parity_20260907.py')
    module_spec=importlib.util.spec_from_file_location('m77_parity_validation',str(path))
    ...
    manifest=dict(frozen,schema='m77_same_bundle_category_low22_v1',tracker=TRACKER,gpu_count=1,shards=shards)
...
def analyze():
    ...
    name='m77_category_low22_analysis'
