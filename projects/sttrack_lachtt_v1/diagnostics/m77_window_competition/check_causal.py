...
ROOT = Path('/root/autodl-tmp/sttrack_m77_window_competition_20260907')
...
result = dict(status='completed_M77_native_parity_and_causal_smoke', observed_utc=datetime.now(timezone.utc).isoformat(),
    ...
    synthetic_competition_contract=synthetic_check, formal_optimizer_steps=0, smoke_weights_saved=False, independent_model_review_pass=False, elapsed_seconds=time.time()-started)
