...
CONTENT_SHA = 'c2b3422b1c5ad19cbb5231d415244431033f238f2da747b11b053eefcd7c686d'
...
def prepare():
    ...
    protocol['selection_provenance'] = ('M73 prospectively compares category and empty training in seeds2027/2028; '
        'seed2027 Category final is the only candidate, conditional on both-seed development and same-head content checks. '
    ...
    spec = dict(status='M73_candidate_entry_CPU_prepared_before_final_results', observed_utc=now(),
        ...
        required_order=['Both M73 seed development gates and completed audit','Fixed seed2027 Category head content gates',
...
def gates():
    ...
    assert (M73/'completion_queue/controller.exit').read_text().strip()=='0'
    follower=read(M73/'completion_queue/result.json')
