...
helper=/root/autodl-tmp/m73_full_preparation_20260907.py
vot=/root/autodl-tmp/m73_full_vot_20260907.py
...
step verification env CUDA_VISIBLE_DEVICES='' "$metric" -u /root/autodl-tmp/verify_m73_three_datasets_20260907.py
printf '0\n' > controller.exit
