...
ROOT = Path('/root/autodl-tmp/sttrack_m78_raw_competition_20260908')
...
def analyze():
    ...
    result=dict(status='complete_recursive_development', observed_utc=datetime.now(timezone.utc).isoformat(),
        ...
        independent_review_pass=False, next='Complete preregistered fixed-head Empty/Swapped content diagnostics regardless of primary gate status; no automatic public evaluation')
