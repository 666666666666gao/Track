"""Conditional full-dataset preparation for the unchanged M78 bundle."""
import argparse
...
EXTRA_SOURCES=['m78_full_preparation_20260908.py','m78_full_vot_20260908.py','verify_m78_three_datasets_20260908.py','m78_full_evaluation_20260908.sh']
CANDIDATE_SPEC_SHA='735d8937aab373a7d806d5f3bff5a1ee85c23ce993e6ddcbbee819fc87a83dd3'


def contracts():
    assert sha(ROOT/'spec.json')==CANDIDATE_SPEC_SHA
    candidate=module('candidate77',Path('/root/autodl-tmp/m78_candidate_evaluation_20260908.py'))
...
def check_sources():
    ...
    result=dict(status='M78_full_dataset_sources_and_counts_verified_only',observed_utc=datetime.now(timezone.utc).isoformat(),
        ...
        next='After actual M78 low22 pass only: causal initialization captions and category encoding, fixed-bundle OPE/full127, saved-output and target verification.',
...
if __name__=='__main__':
    ...
    elif a.action=='eligible':eligible();print('M78_FULL_LOW22_PREREQUISITES_VERIFIED')
