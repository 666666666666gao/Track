...
helper=/root/autodl-tmp/m78_full_preparation_20260908.py
vot=/root/autodl-tmp/m78_full_vot_20260908.py
...
step verification env CUDA_VISIBLE_DEVICES='' "$metric" -u /root/autodl-tmp/verify_m78_three_datasets_20260908.py
printf '0\n' > controller.exit
