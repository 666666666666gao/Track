...
O=R/'completed_comparison_20260908';D=R/'completed_publication_20260908'
...
assert s['head_sha256']['category'].encode() in data and s['head_sha256']['empty'].encode() in data
assert s['recursive_result_sha256'].encode() in data and s['content_result_sha256'].encode() in data
...
files['finalize_m78_completed_20260908.py']=Path(__file__)
