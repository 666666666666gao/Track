...
TRACKER='sttrack_m78_category_low22'
...
def prepare():
    ...
    path=Path('/root/autodl-tmp/m78_learned_entry_parity_20260908.py')
    module_spec=importlib.util.spec_from_file_location('m78_parity_validation',str(path))
    ...
    manifest=dict(frozen,schema='m78_same_bundle_category_low22_v1',tracker=TRACKER,gpu_count=1,shards=shards)
...
def analyze():
    ...
    name='m78_category_low22_analysis'
