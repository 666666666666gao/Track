...
RELATIVE = (
    ...
    'can move or cross. If target identity, count, or ordering is unclear, set the '
    'corresponding fields to null and identity_uncertain to true. ')
COMMON = (
    ...
    'observed frame and the CURRENT frame, in tracking order. Backward playback is '
    ...
    'identity_uncertain (boolean), bbox_1000 ([x1,y1,x2,y2] normalized to 0..1000 '
    'in the CURRENT image, or null), stable_identity (short string), '
...
def main():
    ...
    if args.prepare_only:
        ...
        spec = dict(schema='sttrack_position_text_causal_pilot_v1', count=24,
        ...
        for case in cases:
            ...
            for variant in spec['variants']:
                ...
                message = [{'role': 'user', 'content':
                    [{'type': 'image', 'image': im, 'max_pixels': 640 * 480} for im in images] +
