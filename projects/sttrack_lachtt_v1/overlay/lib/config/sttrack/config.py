...
# MODEL.TSG
cfg.MODEL.TSG = edict()
cfg.MODEL.TSG.LAYER = 2
cfg.MODEL.TSG.TRACK_QUERY = 1
cfg.MODEL.TSG.TRACK_QUERY_OLD = 4
# Keep the released behavior opt-out for source compatibility.  The fallback
# configuration enables the fixed-length history required by the architecture.
cfg.MODEL.TSG.FIX_QUERY_WINDOW = False
# MODEL.HEAD
