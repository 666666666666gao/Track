...
class BaseTrainer:
        ...
        for i in range(num_tries):
            try:
                ...
                for epoch in range(self.epoch+1, max_epochs+1):
                    ...
                    if epoch > (max_epochs - 1) or save_every_epoch or epoch > (max_epochs - 6):
                ...
                if fail_safe and i < num_tries - 1:
                    ...
                    if not fail_safe:
                        raise
                    print('Training failed; no automatic evaluation will be launched.')
                    return False
    ...
    def save_checkpoint(self, tag=None):
        ...
        suffix = 'ep{:04d}'.format(self.epoch) if tag is None else str(tag)
        tmp_file_path = '{}/{}_{}.tmp'.format(directory, net_type, suffix)
        torch.save(state, tmp_file_path)

        file_path = '{}/{}_{}.pth.tar'.format(directory, net_type, suffix)
