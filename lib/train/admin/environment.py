...
def create_default_local_file_ITP_train(workspace_dir, data_dir):
    ...
    default_settings = OrderedDict({
        ...
        'depthtrack_test_dir': os.path.join(data_dir, 'depthtrack/test'),
        ...
        'lasher_train_dir': os.path.join(data_dir, 'lasher/trainingset'),
        'lasher_test_dir': os.path.join(data_dir, 'lasher/testingset'),
        'imagenetdet_dir': empty_str,
        'ecssd_dir': empty_str,
        'hkuis_dir': empty_str,
        'msra10k_dir': empty_str,
