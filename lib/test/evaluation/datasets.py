...
dataset_dict = dict(
    ...
    depthtrack=DatasetInfo(module=pt % "depthtrack", class_name="DepthTrackDataset", kwargs=dict(split='test')),
    depthtrack_test=DatasetInfo(module=pt % "depthtrack", class_name="DepthTrackDataset", kwargs=dict(split='test')),
    cdtb=DatasetInfo(module=pt % "cdtb", class_name="CDTBDataset", kwargs=dict(split='test')),
    votrgbd2022=DatasetInfo(module=pt % "votrgbd2022", class_name="VOTRGBD2022Dataset", kwargs=dict(split='test')),
    vot_rgbd2022=DatasetInfo(module=pt % "votrgbd2022", class_name="VOTRGBD2022Dataset", kwargs=dict(split='test')),
)
